...
# app = Flask(__name__)
# # CORS(app, supports_credentials=True, origins=["http://localhost:5000, mysql://doadmin:show-password@db-mysql-nyc3-73469-do-user-14121328-0.i.db.ondigitalocean.com:25060/defaultdb?ssl_mode=REQUIRED"])
...
#     if user:
#         msg = f"Welcome back! Your data: streak = {user.streak}"
#     else:
#         new_id = str(uuid.uuid4())
#         new_user = User(id=new_id, streak=0)
#         db.session.add(new_user)
#         db.session.commit()
#         user_cookie = new_id
#         msg = f"New cookie created: {user_cookie}"

#     resp = make_response({"message": msg})
#     resp.set_cookie("user_id", user_cookie, max_age=60*60*24*365)
#     print("JUST SENT THIS TO THE DATABASE")
#     return resp
