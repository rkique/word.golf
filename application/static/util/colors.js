...
function syncColorMode() {
  ...
  document.documentElement.style.setProperty('--text-color', '#3c3836');        // standard text (fg1)
  document.documentElement.style.setProperty('--background-color', '#f9f5d7');  // primary bg (bg0_h)
  document.documentElement.style.setProperty('--grayed-out-background', '#d5c4a1');  // card/inactive (bg2)
  ...
  document.documentElement.style.setProperty('--grayed-out-color-unfocused', '#ebdbb2');   // bg1 (softest)
  }
  else {
